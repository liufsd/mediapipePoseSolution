...
public class MainGLActivity extends AppCompatActivity {
  private static final String TAG = "MainActivity";

  private Pose faceDetection;
  ...
  private DetectionResultImageView imageView;
  ...
  private SolutionGlSurfaceView<PoseResult> glSurfaceView;
  ...
  private void setupStaticImageDemoUiComponents() {
    ...
    imageView = new DetectionResultImageView(this);
  }
  ...
  private void setupStaticImageModePipeline() {
    ...
    faceDetection.setResultListener(
        faceDetectionResult -> {
          Log.e("faceDetection==>","faceDetectionResult");
//          logNoseTipKeypoint(faceDetectionResult, /*faceIndex=*/ 0, /*showPixelValues=*/ true);
          imageView.setResult(faceDetectionResult);
...
//        (message, e) -> Log.e(TAG, "MediaPipe Face Detection error:" + message));
  ...
  private void setupStreamingModePipeline(InputSource inputSource) {
    ...
    glSurfaceView.setSolutionResultRenderer(new ResultGlRenderer());
